...
if (count($prijzen) > 0){
    ...
    foreach ($prijzen as $key => $prijs){
        ...
        <div class="form-group">
            ...
            <?php } ?>
            <?php echo form_input(array('data-match'=>'','type'=>'number', 'step' => '0.10','name' => "prijs$key",'id' => "prijs$key", 'value' => $prijs->actuelePrijs, 'class' => 'form-control', 'placeholder' => '0,00', 'required' => 'required'));?>
