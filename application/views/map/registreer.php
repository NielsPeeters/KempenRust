...
<div class="form-group">
    ...
    <?php echo form_input(array('name' => 'naam', 'id' => 'naam', 'value' => $persoon->naam, 'class' => 'form-control', 'placeholder' => 'Naam', 'required' => 'required')); ?>
    </br>
    <label for="voornaam" class="control-label">Voornaam</label>
    <?php echo form_input(array('name' => 'voornaam', 'id' => 'voornaam', 'value' => $persoon->voornaam, 'class' => 'form-control', 'placeholder' => 'Voornaam', 'required' => 'required')); ?>
    </br>
    <label for="plaats" class="control-label">Gemeente</label>
